...
class ContactSensor(Device):
  def __init__(self, firefly, package, title, author, commands=[], requests=REQUESTS, device_type=DEVICE_TYPE_CONTACT_SENSOR, capabilities=CAPABILITIES, initial_values=INITIAL_VALUES, **kwargs):
